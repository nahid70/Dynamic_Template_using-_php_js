				...
				<div id="page-content">
					...
					<?php
						...
						if(isset($_POST['save'])){
							...
							$update_query = mysql_query("UPDATE expense_types set name = '$name',
					...
					echo"<form id='demo-form-2' class='col-md-10 center-margin' method='post'>
						...
						<a href='add_new_expense.php' class='btn large primary-bg text-transform-upr font-size-11' id='demo-form-valid' title='Validate!'>
                            <span class='button-content'>
                                Cancel
                            </span>
                        </a>
