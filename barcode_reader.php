            ...
            <div class="form-row" id="barcode">
                ...
                <div class="form-input col-md-4" >
                    <div class="form-input">
                       <select data-placeholder="select customer" id="in" class="chosen-select">
						...
						<?php
							$select_products="select *from  purchase ";
							$query_products=mysql_query($select_products);
                            while($purchase=mysql_fetch_assoc($query_products)){
								$bar_code=$purchase['bar_code'];
								$id=$purchase['id'];
								
								 echo "<option value='$id' />".$bar_code;
							}
						?>   
                        </select>
                    </div>
			  ...
			  <div class="form-row pad0B">
                ...
                <div class="form-input col-md-2">
			  	...
			  	<a onclick="barcode();" class="btn medium radius-all-4 mrg5A ui-state-default tooltip-button" title="Add Another Staff" href="#s-sign-alt"><i class="glyph-icon icon-plus-sign-alt"></i></a>
			  </div>
			</div>
